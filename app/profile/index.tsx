// app/profile/index.tsx — COMPLETED + UPDATED ✅
// Standalone /profile route (navigated to from outside the tab bar)
// Mirrors (tabs)/profile.tsx but with back button instead of tab chrome
