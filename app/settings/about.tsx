  ...
  const content = (
    <SafeAreaView style={{ flex: 1, backgroundColor: "transparent" }} edges={["top", "left", "right"]}>
      ...
      <View style={styles.header}>
        ...
        <Text style={[styles.headerTitle, { color: colors.text }]}>About NebulaNet</Text>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        <View style={[styles.card, { backgroundColor: colors.card, borderColor: colors.border }]}>
          <View style={styles.brandRow}>
            <View style={[styles.logoBubble, { backgroundColor: colors.primary + "18" }]}>
              <Ionicons name="planet-outline" size={22} color={colors.primary} />
            </View>
            <View style={{ flex: 1 }}>
              <Text style={[styles.appName, { color: colors.text }]}>NebulaNet</Text>
              <Text style={[styles.appMeta, { color: colors.textSecondary }]}>nebulanet.space</Text>
            </View>
          </View>
          ...
          <Text style={[styles.body, { color: colors.textSecondary }]}>
            NebulaNet is built for communities — fast posting, clean discovery, and privacy you can control.
          </Text>
...
const styles = StyleSheet.create({
  ...
  logoBubble: { width: 44, height: 44, borderRadius: 22, alignItems: "center", justifyContent: "center" },
